...
public class ThirukkuralBot extends TelegramLongPollingBot {
    ...
    if (update.hasMessage() && update.getMessage().hasText()) {
      ...
      final String username =
          "<a href=\"tg://user?id="
              ...
              + "\">"
              + update.getMessage().getFrom().getFirstName().replaceAll("[^a-zA-Z0-9]", " ")
              + "</a>";
      final String startText =
          "Hello "
              + username
              + ",\n"
              + "I can send you thirukkural its meaning, translations with additional"
              + " information.\n"
      ...
      if (update.getMessage().getText().equals("/start")
        ...
        try {
          ...
          logging(
              ...
              msgId,
              username,
              "https://t.me/c/" + msgChatId.replaceFirst("-100", "") + "/" + msgId);
        }
        ...
        try {
          ...
          msg = execute(message);
          final String apiUrl =
              "https://api-thirukkural.vercel.app/api?num=" + random.nextInt(1329 + 1);
  ...
  public void logging(
      ...
      final String erchatId,
      final String erChatTitle,
      final String ermsgId,
    ...
    try {
      ...
      onLog.setText(
          "[<a href=\"https://t.me/c/"
              + getLogGroup().toString().replaceFirst("-100", "")
              + "/"
              + msg.getMessageId()
              + "\">An Exception Occured</a>]\nPlease forward this message to @VinuXD.");
      execute(onLog);
    } catch (final Exception e) {
      e.printStackTrace();
    }
